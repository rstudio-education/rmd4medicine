...
1. Knit an R Markdown document. **(session 1)**

1. Add text, R code, and output to an R Markdown document. **(session 1)**

1. Create an exploratory data analysis report with R Markdown. **(session 1)**

1. Change the output format of an R Markdown document. **(sessions 2, 3, 4)**
...
1. Re-use your figures and tables to generate other research products, including a powerpoint presentation and a standard conference poster. **(wrap-up)**

...
mock_plus <- mock_sites

write_xlsx(x = mock_plus , 
           path = here::here("mockpaper/data/mockdata.xlsx"), 
           col_names = TRUE)

write_csv(x = mock_plus, 
           path = here::here("mockpaper/data/mockdata.csv"))

write_csv(x = mock_plus %>% filter(site == "Boston"), 
          path = here::here("mockpaper/data/mockboston.csv"))

write_csv(x = mock_plus %>% filter(site %in% c("Boston", "Seattle", "Denver")), 
          path = here::here("mockpaper/data/mockbsd.csv"))

...
1. Edit chunk options (give some ideas here)
...
1. Split up the first big chunk of code into two: `setup` and `packages`
...
`r emo::ji("heavy_check_mark")` **Format your text:** use markdown **bold**, _italics_, <i class="fas fa-list-ul"></i> bullets, and <i class="fas fa-list-ol"></i> lists

--

`r emo::ji("heavy_check_mark")` **Format your output:** use `knitr` chunk options

...
+ Output options (add a table of contents, theme / extra: make it floating, add code download button)
+ Output formats (change the output from `html_document` to `word_document` and now "Knit to Word")
